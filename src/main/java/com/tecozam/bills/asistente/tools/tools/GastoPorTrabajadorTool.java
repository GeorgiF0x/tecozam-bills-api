...
@Slf4j
public class GastoPorTrabajadorTool implements Tool {

    private final OperacionRepository operacionRepository;

    @Override
    public String getName() {
        return "get_gasto_por_trabajador";
    }

    @Override
    public String getDescription() {
        return "Devuelve el gasto agrupado por conductor/trabajador en un rango de fechas. Útil para ver quién gasta más.";
    }
    ...
    public Map<String, Object> getParametersSchema() {
        return Map.of(
            ...
            "properties", Map.of(
                ...
                "limit", Map.of("type", "integer", "description", "Número máximo de trabajadores a devolver", "default", 10)
            ),
    ...
    public ToolResult execute(Map<String, Object> args) {
        ...
        List<Map<String, Object>> data = operacionRepository.findAll().stream()
            .filter(o -> o.getFechaHora() != null
                ...
                && o.getTarjetaResumen() != null
                && o.getTarjetaResumen().getConductor() != null)
            .collect(Collectors.groupingBy(o -> o.getTarjetaResumen().getConductor()))
            .entrySet().stream()
            .map(e -> {
        ...
        ChartSpec chart = new ChartSpec(
            ...
            "Del " + from + " al " + to,
            data,
            Map.of("xKey", "trabajador", "yKey", "importe", "secondaryKey", "litros")
        );
